...
- 
- <strong> [Neural Language Processing](https://github.com/PeterLambertGitt/crypto_2) </strong>–  Modelling twitter sentiment using RNN's to inform crypto trading strategies
